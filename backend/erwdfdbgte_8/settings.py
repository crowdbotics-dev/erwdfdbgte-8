"""
Django settings for erwdfdbgte_8 project.
...
ROOT_URLCONF = 'erwdfdbgte_8.urls'
...
WSGI_APPLICATION = 'erwdfdbgte_8.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "erwdfdbgte_8 API",
    "DESCRIPTION": "API documentation for erwdfdbgte_8 App",
    "VERSION": "v1",
}
